...
function wordeley_plugin_section_three() {
	echo '<p>' . esc_html( __( 'The cache will be automatically refreshed every 30 days.', 'wordeley' ) ) . '</p>';
}
...
function wordeley_plugin_refresh_cache_automatic() {
	...
	<p>
		<?php echo esc_html( __( 'The cache will be automatically refreshed every 30 days.', 'wordeley' ) ); ?>
	</p>
	<?php
}
